...
public class Student_Details {
	...
	public static ArrayList stu_detail = new ArrayList();
	...
	void login() {
		...
		for(int i=0;i<s.size();i++) {
			if(stu_id.get(i).equals(id) && s.get(i).equals(name.replace("_", " "))) {
				System.out.println("Login Successful");
				if(stu_detail.get(i).equals(" ")) {
	...
	void getmarkscard(int i) {
		...
		System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
		System.out.println();
		System.out.println(stu_detail.get(i));
		System.out.println();
	}
	
	void sdetails(int i) {
		try {
			String sdetails = "ID           : "+stu_id.get(i)+"\n"+"Name         : "+s.get(i)+"\n";
			System.out.println("Enter your details : ");
			System.out.println("Age :");
			int age = sc.nextInt();
			sdetails = sdetails + "Age          : "+age+"\n";
			System.out.println("School : ");
			String school = sc.next();
			sdetails = sdetails + "School        : "+school.replace("_", " ")+"\nCourse ID    : "+Course.cid.get(i)+"\nCourse Name  : "+selectedcourse.get(i);
			sdetails = sdetails +"\nProfessor    : "+Professor_Details.p.get(i);
			stu_detail.set(i, sdetails);
			System.out.println();
